...
$(document).ready(function(){
	...
	$.getJSON("https://api.countapi.xyz/hit/https://publish.uwo.ca/~cmukher/", function(response) {
...
function resetViews() {
	$.getJSON("https://api.countapi.xyz/set/https://publish.uwo.ca/~cmukher/", function(response) {
